...
export function SignUpPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0F172A] flex items-center justify-center p-4">
      <div className="w-full max-w-5xl grid lg:grid-cols-2 gap-0 overflow-hidden rounded-3xl shadow-[0_20px_100px_rgba(0,0,0,0.7)]">
        {/* Left Panel - Branding */}
        <div className="bg-gradient-to-br from-[#1E293B] to-[#0F172A] p-10 flex flex-col justify-center relative overflow-hidden border-r border-white/10">
          <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-40" />
          
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 bg-gradient-to-br from-[#3B82F6] to-[#06B6D4] rounded-2xl flex items-center justify-center shadow-[0_0_30px_rgba(59,130,246,0.5)]">
